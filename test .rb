...
class VKAPI
	...
	open(@result["photo_max_orig"]) do |image|
	...
	#	@result["home_phone"]
	#	if @result["home_phone"] != nil
	#	logger = GELF::Logger.new("syslog.synergy.ru", 12201, "WAN", { :facility => "test_phone_number" })
	...
	firstobject.user_info 135919653, "b7caccad399f0c6e08ed4511279be4a30c35165b0d6ce46bc8b11bb3f806f01faad47e330aebacc30fd47"
